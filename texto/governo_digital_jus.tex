\chapter{Poder Judiciário com garantidor de direitos}
...
De forma específica, dados internacionais confirma a real democracia do Brasil. \cite{rule-of-law-index} mostra na figura \ref{fig:key-features-of-liberal-democracy} como os índices de uma democracia liberal no Brasil são altos.
...
O posicionamento do STJ foi reiterado por outra decisão, a Reclamação 40.676/SP.
...
Como fundamentação jurídica da defesa da liberdade de expressão, o TJRS citou a ADI 4451, conhecida, segundo \cite{liberdade_expressao_artistica_tjrs}, como a "ADI do Humor". A referida ADI, conforme \cite{adi_4451}:
...
Da sustanção dos efeitos jurídicos dos dispositivos legais supracitados, \cite{liberdade_expressao_artistica_tjrs} cita que a ADI 4.451 garantiu a liberdade de expressão ampla e protegida, inclusive quando se traduz em formas de humor ácido e irreverente, que, muitas vezes, desafiam as convenções sociais e provocam desconforto nas audiências.

\cite{liberdade_expressao_artistica_tjrs} complementou que a decisão da ADI 4.451 teve a sensibilidade de entender as peculiaridades do humor, que por sua natureza pode desafiar normas e causar lides. Concomitantemente, o humor não tem a função de agradar, mas sim provocar reflexão, questionar status quo e, por vezes, expor contradições sociais de forma irônica e ácida.
...
\cite{stf_caderno_liberdadeexpressao} cita outras julgados do STF relativos à liberdade de expressão no periódico \textbf{Cadernos de Jurisprudência do Supremo Tribunal Federal: Concretizando Direitos Humanos}\footnote{\url{https://shorturl.at/A7DxZ}}, tais como o HC 82.424, o RE 511.961, as ADPF 187, 4.815, as ADI 5.122, 2.566, 4.451, por exemplo.

Na função de garantidor de direitos, a independência do Poder Judiciário mostra como um pilar do funcionamento do Poder. Como forma de evitar a ingerência do Poder Executivo, \cite{pires2021paradoxo} argumenta que a Constituição Federal estabeleceu o STF é o órgão responsável pela elaboração do orçamento anual da Justiça Federal e pelo encaminhamento direto ao Congresso Nacional. Assim, limitou-se o poder do Governo Federal sob o Poder Judiciário. 
...
\section{Judicialização das políticas públicas}

\section{Quantidade de processos judiciais no DataJud}

\section{Judicialização do Sistema Único de Saúde}