...
\cite{cf88} concedeu ao Poder Judiciário autonomia administrativa e financeira. A importância da autonomia para o Poder Judiciário se confirma ao analisar as figuras \ref{fig:jus_constraints_on_gov}, \ref{fig:judicial-corruption-score}, \ref{} relativas ao controle judicial sob o Poder Executivo,  corrupção no Poder Judiciário e o Estado de Direito.
...
A figura \ref{fig:rule-of-law-index-bti} mostra à situação histórica (2005-2023) do Estado de Direito no Brasil.

\begin{figure}[H]
	\centering
	\caption{Estado de Direito em 2023}
	\includegraphics[width=1\linewidth]{figuras/rule-of-law-index-bti.png}
	\label{fig:rule-of-law-index-bti}
	\footnotesize{Fonte: \cite{rule-of-law-index-bti}.}
\end{figure}

Como expresso por \cite{rule-of-law-index-bti}, o indicador tem as seguintes faixas de pontuações: pobre (1-2,49), deficiente (2,5-4,49), justo (4,5-6,49), robusto (6,5-8,49) e excelente (8,5-10). Nesse sentido, o Brasil está na faixa \textbf{robusto} desde 2005, ano em que o indicador começou a ser medido.
