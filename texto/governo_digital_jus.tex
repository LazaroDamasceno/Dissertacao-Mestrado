...
Outra decisão afeta aos direitos é a jurisprudência do Superior Tribunal de Justiça em relação a interpretação judicial e a aplicação do art. 318-A do Código de Processo Penal (CPP), introduzido pela Lei nº 13.769, de 2018, haja vista \cite{cpp}:
