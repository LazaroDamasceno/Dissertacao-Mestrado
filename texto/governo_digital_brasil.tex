...
Para \cite{ocde_going_digital_2022}, o relatório \textbf{Assessing national digital strategies and their governance} da OCDE propões uma nova metodologia para avaliar a abrangência para dar apoio a governo em desenvolvimento, monitorando e avaliando suas estratégias digitais nacionais.
...
\begin{figure}[H]
	...
	\footnotesize{Fonte: \cite{ocde_going_digital_2022}.}
\end{figure}
...
\begin{longtable}[c]{@{}ll@{}}
	...
	%
	\midrule
	\multicolumn{2}{l}{\textbf{Continuação da tabela \ref{tab:dimensoes_going_digital}}} \\*
	\midrule
	\endhead
	%
	\bottomrule
	...
	\footnotesize{Fonte: elaboração baseada em \cite{ocde_portal_going_digital}.}
\end{longtable}
