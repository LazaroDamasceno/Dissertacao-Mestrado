...
\begin{figure}[H]
	\centering
	\caption{Comparação do DGI do Brasil e da média da OECD de 2020}
	\includegraphics[width=1\linewidth]{figuras/comparacao_dgi_brasil_mundo_2020}
	\label{fig:comparacao_dgi_brasil_mundo_2020}
	\footnotesize{Fonte: \cite{dgi_2020}.}
\end{figure}

\begin{figure}[H]
	\centering
	\caption{Comparação do DGI do Brasil e da média da OECD de 2023}
