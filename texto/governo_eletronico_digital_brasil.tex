...
\begin{figure}[H]
	\centering
	\caption{Comparação do indicador Government Effectiveness do WGI do Brasil e do mundo}
	\includegraphics[width=1\linewidth]{figuras/comparacao_wgi_ge_brasil_mundo}
	\label{fig:comparacao_wgi_ge_brasil_mundo}
	\footnotesize{Fonte: \cite{kaufmann2024worldwide}.}
\end{figure}
...
Outro indicador, o \textbf{Control of Corruption}, segundo \cite{kaufmann2024worldwide}, captura as percepções da extensão de como o poder estatal é exercido para ganhos privados, incluindo as formas pequenas e grandes de corrupção, bem com, captura o estado da elite e dos ganhos privados.

????/ MOSTRAR O GOV EFFECTNES DO WGI DO BRASIL 
