...
\cite{ONU_egdi} argumenta que o E-Participation Index deriva do EGDI como índice suplementar ao relatório E-Government Survey. A estrutura do índice suplementar esta presente na tabela \ref{}.
...
\begin{longtable}{|p{4cm}|p{8cm}|}
	...
	\endhead
	\hline
	E-information & Facilitação da participação dos cidadãos via informações públicas e acesso a informação sem necessidade de pedido ou sob pedido. \\
	\hline
	E-consultation & Engajamento dos cidadãos em contribuições e deliberações sobre políticas publicas e serviços públicos. \\
	\hline
	E-decision-making & Empoderamento dos cidadãos via a opção de coparticipação na elaboração de políticas e coprodução de componentes de serviços e entrega de modalidades. \\
	\hline
\end{longtable}

\cite{ONU_egdi} esclarece que o E-Participation Index de um país reflete os mecanismos do índice que são empregados pelo governo quando se faz comparações com todos outros países. 
...
Adicionalmente, cada componente citado na figura \ref{fig:egdi_componentes} será descrito individualmente nos próximos parágrafos.
