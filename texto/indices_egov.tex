...
\begin{figure}[H]
    \centering
    \caption{Coeficiente de correlação de Pearson: do uso de internet e o EGDI \textit{per capita} dos 193 países}
...
\begin{figure}[H]
    \centering
    \caption{Coeficiente de correlação de Pearson: PIB \textit{per capita} PPP em USD e EGDI do Brasil}
