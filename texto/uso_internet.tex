...
\begin{figure}[ht]
    ...
    \footnotesize{Fonte: elaboração baseada em \cite{ONU_populacao_paises}, \cite{pnda_continua_anual_2016_2023} e \cite{ONU_tamanho_paises}.}
\end{figure}
...
Para entender a figura \ref{fig:distribuicao_uso_internet_regioes}, foi feita um análise da correlação de Pearson com o índice de uso de internet com a população e densidade populacional de cada região nos anos de 2016-2019 e 2021-2023.
...
\begin{figure}[ht]
    ...
    \footnotesize{Fonte: elaboração baseada em \cite{IBGE_censo_2022} e \cite{pnda_continua_anual_2016_2023}.}
\end{figure}
