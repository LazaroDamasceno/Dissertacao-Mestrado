...
\begin{figure}[H]
    \centering
    \caption{Coeficiente de correlação de Pearson: índice do uso de internet, população brasileira e extensão territorial}
...
O coeficiente de correlação de Pearson mais positivo e forte foi entre \texttt{Índice do Uso de internet} e \texttt{População brasileira}. De maneira contrária, \texttt{Extensão territorial} tem um coeficiente negativo com \texttt{Índice do Uso de internet} e \texttt{População brasileira}. 

Portanto, será considerada apenas a relação \texttt{Índice do Uso de internet} e \texttt{População brasileira}, pois o crescimento da população (até 2023) está altamente correlacionado com o crescimento do uso de internet no Brasil.
...
Como já foi provado que há correlação entre o índice do uso de internet e o crescimento da população brasileira (figura \ref{fig:internet_correlacao}), testou-se a correlação entre o índice do uso de internet e a densidade demográfica das regiões.
