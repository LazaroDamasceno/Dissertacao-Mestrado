...
Como \cite{mitkiewicz2024transformaccao} focou no Governo Federal, escolheu-se o Poder Judiciário para ter suas políticas de governo digital analisadas com base no índice EGDI.
...
Cada componentes será detalhado, conforme \cite{relatorio_egdi_2024}.

Para \cite{relatorio_egdi_2024}, o valor do OSI, tal como, o valor do EGDI, não foi feito para ser uma medição absoluta, mais para capturar a performance online dos países em relação ao demais em determinado momento. Em razão do OSI ser um ferramenta composta, uma valor alto é um indicativo de boas práticas atuais, não de perfeição. Similarmente, um valor mais baixo ou um valor que não mudou desde a publicação da última pesquisa não significa falta de provisão no desenvolvimento do governo digital.

Enquanto o desenvolvimento dos serviços online de um país é constantemente um preditor sólido de um desenvolvimento geral de governo eletrônico, os componentes TII e HCI não estão sempre alinhados, em razão de serem considerados para o cálculo do EGDI. É importante identificar casos em que o nível do OSI é mais alto ou baixo do nível geral do EGDI do modo que políticas direcionadas podem ser adotadas e recursos suficientes podem ser alocados para o melhoramento do fornecimento dos serviços online.

O OSI tem 5 sub-índices: 

\begin{itemize}
	\item Provisão de serviços.
	\item Framework institucional de suporte ao desenvolvimento de governo eletrônico.
	\item Provisão de conteúdo.
	\item Aspectos tecnológicos dos portais.
	\item Participação eletrônica.
\end{itemize}
...
\section{Online Service Index e Telecommunication Infrastrucure Index como impulsionadores de melhorias no serviço público}