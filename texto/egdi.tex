...
Considerando as informações anteriores, as figuras \ref{mapa_coropletico_paises_egdi}, \ref{mapa_coropletico_paises_epi}, \ref{mapa_coropletico_paises_osi}, \ref{mapa_coropletico_paises_hci} e \ref{mapa_coropletico_paises_tii} contêm mapas coropléticos que monstram o EGDI, seus componentes e o EPI pelo mundo.

\begin{figure}[H]
	\centering
	\caption{EGDI pelo mundo em 2024}
...
\begin{figure}[H]
	\centering
	\caption{EPI pelo mundo em 2024}
...
\begin{figure}[H]
	\centering
	\caption{OSI pelo mundo em 2024}
...
\begin{figure}[H]
	\centering
	\caption{HCI pelo mundo em 2024}
...
\begin{figure}[H]
	\centering
	\caption{TII pelo mundo em 2024}
	\includegraphics[width=1\linewidth]{figuras/mapa_coropletico_paises_tii}
	\label{fig:mapa_coropletico_paises_tii}
	\footnotesize{Fonte: elaboração própria baseada em \cite{ONU_EGDI_mapa}.}
\end{figure}

Pela análise das figuras \ref{mapa_coropletico_paises_egdi}, \ref{mapa_coropletico_paises_epi}, \ref{mapa_coropletico_paises_osi}, \ref{mapa_coropletico_paises_hci} e \ref{mapa_coropletico_paises_tii}, nota-se como o Brasil tem uma pontuação alta na escala, estando sempre em posições altas.

Nesse sentido, questinou-se qual é a pontuação atingida pelo Brasil e qual é a média mundial do EGDI, seus componentes e o EPI. Assim, a figura \ref{fig:comparacao_egdi_brasil_mundo} expõe os valores do EGDI, seus componentes e o EPI do Brasil e a média mundial deles.

COMENTAR A FIGURA \ref{fig:comparacao_egdi_brasil_mundo}
	
Analisou-se, concomitantemente, se o EGDI tem relação com o índice de democracia, PIB \textit{per capita} PPC em USD e com os gastos públicos como porcentagem do PIB eleitoral.
...
O resultado foi dividido nas figuras \ref{fig:correlacao_egdi_pib} e \ref{fig:correlacao_egdi_gastospublicos}.

\begin{figure}[H]
	\centering
	\caption{Coeficientes de correlação entre EGDI, seus componentes e o EPI com o PIB \textit{per capita} PPC}
	\includegraphics[width=1\linewidth]{figuras/correlacao_egdi_pib.png}
	\label{fig:correlacao_egdi_pib}
