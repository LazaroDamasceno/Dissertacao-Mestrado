...
As demonstrated by the figure \ref{fig:person_class}, the class was used to create the Java model presented in the figure \ref{fig:kotlin_person_model}, that will be persisted into a MongoDB document. 
