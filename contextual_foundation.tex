...
The consolidated component diagram is illustrated in the figure \ref{}.
...
\begin{figure}[H]
	...
	\includegraphics[width=1\linewidth]{figures/api/component_diagram_person.png}
	\label{fig:component_diagram_person}
	\footnotesize Source: Author's creation.
\end{figure}
...
\begin{figure}[H]
	...
	\includegraphics[width=1\linewidth]{figures/api/component_diagram_customer.png}
...
\begin{figure}[H]
	...
	\includegraphics[width=1\linewidth]{figures/api/component_diagram_doctor.png}
...
\begin{figure}[H]
	...
	\includegraphics[width=1\linewidth]{figures/api/component_diagram_medical_slot.png}
