...
The details of each module mentioned in the consolidated component diagram are demonstrated in the figures \ref{fig:component_diagram_person}, \ref{fig:component_diagram_doctor}, \ref{fig:component_diagram_customer}, \ref{fig:component_diagram_slot} and \ref{fig:component_diagram_appointment}.
