...
The component diagram was split into the figures \ref{fig:component_diagram_person}, \ref{fig:component_diagram_customer}, \ref{fig:component_diagram_doctor}, \ref{fig:component_diagram_medical_slot} and \ref{fig:component_diagram_medical_appointment}.

\begin{figure}[H]
	\centering
	\caption{Component Diagram: Person's Piece}
...
\begin{figure}[H]
    \centering
    \caption{Component Diagram: Customer's Piece}
...
\begin{figure}[H]
	\centering
	\caption{Component Diagram: Doctor's Piece}
...
\begin{figure}[H]
	\centering
	\caption{Component Diagram: Medical Slot's Piece}
	\includegraphics[width=1\linewidth]{figures/api/component_diagram_medical_slot.png}
	\label{fig:component_diagram_medical_slot}
	\footnotesize Source: Author's creation.
\end{figure}

\begin{figure}[H]
	\centering
	\caption{Component Diagram: Medical Appointment's Piece}
	\includegraphics[width=1\linewidth]{figures/api/component_diagram_medical_appontment.png}
	\label{fig:component_diagram_medical_appointment}
	\footnotesize Source: Author's creation.
\end{figure}
