...
\begin{figure}[H]
    ...
    \caption{Person Registration Service}
     \includegraphics[width=1\linewidth]{figures/api/person_registration_service.png}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.87\linewidth]{figures/api/person_registration_service_impl.png}
...
\begin{figure}[H]
	...
	\includegraphics[width=1\linewidth]{figures/api/component_diagram_consolidated.png}
	\label{fig:component_diagram_consolidated}
	\footnotesize Source: Author's creation.
\end{figure}

The details of each module mentioned in the consolidated component diagram are demonstrated in the figures \ref{fig:component_diagram_person}, \ref{fig:component_diagram_customer}, \ref{fig:component_diagram_doctor}, \ref{fig:component_diagram_slot} and \ref{fig:component_diagram_appointment}.

\begin{figure}[H]
	\centering
	\caption{Component Diagram: Person}
	\includegraphics[width=0.75\linewidth]{figures/api/component_diagram_person.png}
...
\begin{figure}[H]
	...
	\includegraphics[width=0.75\linewidth]{figures/api/component_diagram_customer.png}
...
\begin{figure}[H]
	...
	\includegraphics[width=0.75\linewidth]{figures/api/component_diagram_doctor.png}
...
\begin{figure}[H]
	...
	\includegraphics[width=0.75\linewidth]{figures/api/component_diagram_medical_slot.png}
...
\begin{figure}[H]
	...
	\includegraphics[width=1\linewidth]{figures/api/component_diagram_medical_appointment.png}
...
Finally, the endpoints of the API are shown in the figures \ref{}, \ref{}, and \ref{} 
...
As discussed by the \hyperref[subsection:http_semantics]{subsection HTTP Semantics}, the endpoints present in the figures \ref{}, 
\ref{}, and \ref{} are compliant with \hyperref[appendix:glossary]{RFC} \href{https://www.rfc-editor.org/rfc/rfc9110.html}{9110} in both methods's guidelines and \hyperref[appendix:glossary]{URI} format, due to the presence of the method and the \hyperref[appendix:glossary]{URI}'s relative path. Swagger UI was used to create the content shown in the figures \ref{}, \ref{}, and \ref{}, due to its ability, as stated by \cite{mcnamara2022flexible}, to expose graphically API resources, which are automatically generated from an OpenAPI Specification.\footnote{\href{https://swagger.io/tools/swagger-ui/}{See the official site of Swagger UI.}}
