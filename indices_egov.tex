...
Os coeficientes de correlação Os coeficientes de correlação das  figuras \ref{fig:dispensao_egov_pib} e \ref{fig:dispensao_epart_pib} são 0.82 e 0.67, respectivamente, e das figuras \ref{fig:dispersao_egov_indicedemocracia} e \ref{fig:dispersao_epart_indicedemocracia} são 0.04 e 0.05, respectivamente. Portanto, pode-se afirmar-se que EGDI e o \textbf{E-Participation} tem forte relação com o PIB \textit{per capita} PPC. De maneira contrária, EGDI, \textbf{E-Participation}n e o índice de democracia eleitoral são variáveis independentes.
...
\subsubsection{Human Capital Index do Brasil}
...
\subsubsection{Telecommunication Infrastructure Index do Brasil}
